...
<a class="btn-icon wishlist add-to-wishlist rounded" onclick="add_wishlist(<?php echo $prdt_id; ?>) " href="javascript:void(0)"><i class="icon an an-heart-l"></i> <span class="tooltip-label">Add To Wishlist</span></a>
