               ...
               <div class="collection-header">
                ...
                <form method="post" action="" class="customer-form">	
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <label for="CustomerEmail">Username or email address  <span class="required">*</span></label>
...
<input type="password" name="password" placeholder="Password" id="CustomerPassword" value="" required />                        	
	...
	<a href="lost-password.php">Lost your password?</a> <a href="register.php">If you don't have an account?</a>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        $clt_dtl="select * from users where `email`='$emnl' and `password`='$mdf_pswd'";
