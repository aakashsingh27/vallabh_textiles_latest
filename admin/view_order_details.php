...
">
    ...
    <p class="pl-2 pb-0 mb-1" style="font-size: 14px;"><a title="Click to view this user details" href="view_user_details.php?id=<?php echo $ussr_iid;?>"> <b><?php echo $uuse_neme;?> , <?php echo $uuse_mob?></b></a> </p>
