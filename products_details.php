...
<div class="lightboximages">
    ...
    <button type="button" onClick="add_to_qty_cart(<?php echo $prdt_id;?>)" class="btn rounded-0 product-form__cart-submit mb-0"><span>Add to cart</span></button>
                                    ...
                                    <p class="infolinks d-flex-center mt-2 mb-0">
                                        <a class="btn add-to-wishlist" onclick=" add_wishlist(<?php echo $prdt_id?>) " href="javascript:void(0)"><i class="icon an an-heart-l me-1" aria-hidden="true"></i><span> Add to Wishlist</span></a>
                                    </p>
                                ...
                                <!-- Product Info -->
                                <div class="freeShipMsg"> <b>Category:</b> towel </div>
                                <!-- End Product Info -->
                            </div>
                        </div>
                    </div>
