...
<a class="add-wishlist d-flex-center text-uppercase me-3" onClick="<?php if(isset($_SESSION['user_id']))
{ ?> add_wishlist(<?php echo $prdt_id;?>) <?php } else { ?> toastr.error('Please login') <?php }?>" href="javascript:void(0)" title="Add to Wishlist"> <i class="icon an an-heart-l me-1"></i> <span>Add to Wishlist</span></a>
