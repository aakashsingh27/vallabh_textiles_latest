<?php include "include/header.php"?>
			...
			<h4 class="address d-flex align-items-center my-3"><i class="an an-map-marker-al me-2"></i> We are online 24/7</h4>
			...
			<h4 class="email d-flex align-items-center my-3"><i class="an an-envelope-l me-2"></i> <b class="me-1 d-none">Email:</b> <a href="mailto:info@example.com">info@example.com</a></h4>
			</div>
			</div>
