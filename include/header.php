...
<div class="logo">
<a href="index.php">
<img src="assets/images/logo-sticky-demo3.png" class="logo-img default-logo mh-100" alt="text" title="Vallabh Textiles " width="220" />
<img src="assets/images/logo-sticky-demo3.png" class="logo-img sticky-logo mh-100" alt="Vallabh Textiles " title="Vallabh Textiles " width="220" />
...
<!--End Minicart Drawer-->
<!--Setting Dropdown-->
<div class="setting-link iconset pe-0"><a href="wishlist.php"><i class="icon an an-heart-l"></i></a><span class="tooltip-label">Wishlist</span></div>
<?php
}
?>
<!--End Setting Dropdown-->
